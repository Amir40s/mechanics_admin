...
import 'package:mechanics_admin/constants.dart';
import 'package:mechanics_admin/helper/button_widget.dart';
import 'package:mechanics_admin/helper/text_widget.dart';
import 'package:mechanics_admin/main_screen.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Image.asset("assets/images/image.webp",width: 300.0,height: 300.0,fit: BoxFit.cover,),
